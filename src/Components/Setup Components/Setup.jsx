...
const Setup = () => {
  ...
  const [formData, setFormData] = useState({
    organisationName: '',  // Changed field name
    registerPersonName: '',
    founderFirstName: '',
    founderLastName: '',
    mobileNumber: '',
  ...
  useEffect(() => {
    const updatedFormData = {
      organisationName: formData.organisationName,  // Changed field name
      registerPersonName: formData.registerPersonName,
      ...
      syllubusType: formData.syllubusType,
      ...
      founderPassword: formData.founderPassword,
    };
  ...
  const validateForm = () => {
    let formErrors = {};
    if (!formData.organisationName) formErrors.organisationName = "Organization Name is required";  // Changed field name
    ...
    if (!formData.email) formErrors.emai = "Email is required";  // Corrected typo in 'email'
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      navigate('/setupconfirmation', { state: { formData } });
          ...
          <div className="w-full md:ml-96 p-4 md:p-6 h-full overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  name="organisationName"  // Changed field name
                  className="mt-1 block w-full p-1 md:p-2 border border-gray-300 rounded-md"
                  value={formData.organisationName}  // Changed field name
                  onChange={handleChange}
                />
                {errors.organisationName && <span className="text-red-500 text-xs">{errors.organisationName}</span>}  // Changed field name
              </div>
              <div>
